<template>
    <div class="user-management">
        ...
        <el-table :data="displayedData" class="user-table">
        ...
        <el-pagination :page-count="totalPages" :current-page="currentPage" :page-size="pageSize" @current-change="handlePageChange"
