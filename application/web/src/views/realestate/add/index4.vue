    ...
    <div class="app-container">
        <el-form ref="ruleForm" v-loading="loading" :model="ruleForm" :rules="rules" label-width="100px"
            ...
            <el-form-item label="建造年份" prop="constructionYear">
                <el-date-picker v-model="ruleForm.constructionYear" type="date" placeholder="选择日期" style="width: 100%;" />
            </el-form-item>
            ...
            <el-form-item label="联系电话" prop="propertyStatus">
                <el-input v-model="ruleForm.phone" placeholder="请输入>联系电话" />
            </el-form-item>
